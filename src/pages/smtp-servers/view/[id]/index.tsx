...
import { getSmtpServerById } from 'apiSdk/smtp-servers';
import { SmtpServerInterface } from 'interfaces/smtp-server';

function SmtpServerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('smtp_server', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/smtp-servers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Server Address" text={data?.server_address} />
