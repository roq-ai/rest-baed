...
export function StartupListPage(props: StartupListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStartups({
        relations: ['user', 'email_inbox.count', 'smtp_server.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('email_inbox', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'email_inbox',
          header: 'Email Inbox',
          accessorKey: 'email_inbox',
          cell: ({ row: { original: record } }: any) => record?._count?.email_inbox,
        }
      : null,
    hasAccess('smtp_server', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'smtp_server',
          header: 'Smtp Server',
          accessorKey: 'smtp_server',
          cell: ({ row: { original: record } }: any) => record?._count?.smtp_server,
        }
      : null,
